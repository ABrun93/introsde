 ...
 * 
 */
@WebServiceClient(name = "PeopleService", targetNamespace = "http://webservice.document.soap/", wsdlLocation = "http://localhost:6902/ws/people?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PEOPLESERVICE_QNAME = new QName("http://webservice.document.soap/", "PeopleService");
     ...
     * 
     * @return
     *     returns PeopleInterface
     */
    @WebEndpoint(name = "PeopleImplementationPort")
    public PeopleInterface getPeopleImplementationPort() {
        return super.getPort(new QName("http://webservice.document.soap/", "PeopleImplementationPort"), PeopleInterface.class);
    }
     ...
     */
    @WebEndpoint(name = "PeopleImplementationPort")
    public PeopleInterface getPeopleImplementationPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.document.soap/", "PeopleImplementationPort"), PeopleInterface.class, features);
    }
